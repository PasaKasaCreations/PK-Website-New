              ...
              {showVideo && hasVideo ? (
                ...
                <>
                  ...
                  {hasVideo && (
                    ...
                    >
                      <div className="flex items-center justify-center h-14 w-14 rounded-full bg-white shadow-xl group-hover:scale-110 transition-transform">
                        <Play
                  ...
                  {sortedProjects.length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-white/90 hover:bg-white flex items-center justify-center shadow-md"
                      ...
                      <button
                        onClick={goToNext}
                        className="absolute right-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-white/90 hover:bg-white flex items-center justify-center shadow-md"
              ...
              <div className="grid grid-cols-2 gap-2">
                {sortedProjects.slice(0, 4).map((project, index) => (
                  <button
                    ...
                    className={`text-left flex items-center gap-2 p-2 rounded-lg transition-colors ${
                      index === currentIndex
                        ? "bg-blue-50 text-blue-700"
                        : "hover:bg-slate-50"
                    }`}
                  >
                    <div className="relative h-8 w-10 rounded overflow-hidden flex-shrink-0 bg-slate-100">
